<template>
    <div>
        ...
        <div class="product-item" v-for="adi in whiteAdi" :key="adi.Id">
            ...
            <div class="Product-info" >
               ...
               <img :src="adi.Image">
                   ...
                   Quantity:
                   <button @click="addQuantityAdi">+</button>
                   <input type="number" max="99" v-model="adi.quaN">
                   <button @click="reduceQuantityAdi">-</button>
                   </div>
...
export default {
    ...
    computed: {
        whiteAdi() {
            return this.$store.state.whiteAdi
        }
    },
    methods: {
        ...mapMutations([
