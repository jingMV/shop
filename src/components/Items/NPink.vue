<template>
    <div>
        ...
        <div class="product-item" v-for="np in nPink" :key="np.Id">
            ...
            <div class="Product-info" >
               ...
               <img :src="np.Image">
                   ...
                   Quantity:
                   <button @click="addQuantityNP">+</button>
                   <input type="number" max="99" v-model="np.quaN">
                   <button @click="reduceQuantityNP">-</button>
                   </div>
