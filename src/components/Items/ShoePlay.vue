<template>
    <div>
        ...
        <div class="product-item" v-for="sp in shoePlay" :key="sp.Id">
            ...
            <div class="Product-info" >
               ...
               <img :src="sp.Image">
                   ...
                   Quantity:
                   <button @click="addQuantitySP">+</button>
                   <input type="number" max="99" v-model="sp.quaN">
                   <button @click="reduceQuantitySP">-</button>
                   </div>
...
export default {
    ...
    computed: {
        shoePlay() {
            return this.$store.state.shoePlay
        }
    },
    methods: {
        ...mapMutations([
