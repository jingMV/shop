<template>
    <div>
        ...
        <div class="product-item" v-for="nb in nikeBlue" :key="nb.Id">
            ...
            <div class="Product-info" >
               ...
               <img :src="nb.Image">
                   ...
                   Quantity:
                   <button @click="addQuantityNB">+</button>
                   <input type="number" max="99" v-model="nb.quaN">
                   <button @click="reduceQuantityNB">-</button>
                   </div>
...
export default {
    ...
    computed: {
        nikeBlue() {
            return this.$store.state.nikeBlue
        }
    },
    methods: {
        ...mapMutations([
