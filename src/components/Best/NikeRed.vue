<template>
    <div>
        ...
        <div class="product-item" v-for="nr in nikeRed" :key="nr.Id">
            ...
            <div class="Product-info" >
               ...
               <img :src="nr.Image">
                   ...
                   Quantity:
                   <button @click="addQuantityNR">+</button>
                   <input type="number" max="99" v-model="nr.quaN">
                   <button @click="reduceQuantityNR">-</button>
                   </div>
...
export default {
    ...
    computed: {
        nikeRed() {
            return this.$store.state.nikeRed
        }
    },
    methods: {
        ...mapMutations([
